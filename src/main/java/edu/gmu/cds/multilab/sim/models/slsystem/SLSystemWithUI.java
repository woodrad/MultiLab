...
//sim.models.slsystem.SLSystemWithUI
*/
...
public class SLSystemWithUI extends GUIState
    {
    ...
    public static void main(String[] args)
        {
        new SLSystemWithUI().createController();
        }
    
    public SLSystemWithUI() { super(new SLSystem(System.currentTimeMillis())); }
    
    public SLSystemWithUI(SimState state) { super(state); }
    ...
    public void setupPortrayals()
        ...
        systemPortrayal.setField(((SLSystem)state).drawEnvironment);
    ...
    public void init(Controller c)
        ...
        // setup the defaults
        SLSystem ls = (SLSystem)state;
        SLSystemData.setVector(ls.l.code, "F");
        ls.l.seed = "F";
