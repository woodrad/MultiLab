...
// Class RuleUI
package edu.gmu.cds.multilab.sim.models.slsystem;
...
public class RuleUI extends JPanel
    ...
    // it takes the currently entered data for rules and sends it to the SLSystem.SLSystemData intstance
    void getRulesFromUI()
        {
        ...
        SLSystemData.setVector(ls.l.code, ls.l.seed);
        // expansions
    ...
    // constructor
    public RuleUI(SLSystemWithUI nLsui, DrawUI nDui)
        {
        lsui = nLsui;
        ls = (SLSystem)lsui.state;
        dui = nDui;
    ...
    public void init()
        ...
        buttonLoad.addActionListener(new ActionListener()
            ...
            public void actionPerformed(ActionEvent e)
                ...
                try
                    ...
                    ls.l = (SLSystemData)in.readObject();
                    in.close();
                    ...
                    for(int t=0; t<ls.l.rules.size(); t++)
                        ...
                        ruleTable.setValueAt(SLSystemData.fromVector(((Rule)(ls.l.rules.get(t))).replace), t, 1);
                        }
                    }
                catch (Exception ex)
                    {
        ...
        */
        ...
        // rules table setup
        // same defaults as in SLSystemWithUI.java
        seedField.setText("F");
